...
def bonuses_menu_kb(is_premium: bool = False) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} в меню", callback_data="nav:more")])
...
def profile_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=f"{BACK} в меню", callback_data="nav:progress")],
    ])
...
def upgrades_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=f"{BACK} в меню", callback_data="nav:economy")],
    ])
...
def garage_slot_purchase_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=BACK, callback_data="upg:back")],
    ])
...
def farm_upgrade_kb(next_level: int, can_afford: bool) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=BACK, callback_data="upg:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def garage_sellmode_kb(cars: list, selected_ids: set, page: int, total_pages: int, owner_id: int) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} в гараж", callback_data=f"garage:page:{owner_id}:1")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def garage_car_detail_kb(entry_id: int, is_favorite: bool, owner_id: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=f"{BACK} в гараж", callback_data=f"garage:page:{owner_id}:1")],
    ])
...
def casino_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=f"{BACK} в меню", callback_data="nav:pvp")],
    ])
...
def exchange_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=f"{BACK} в казино", callback_data="casino:back")],
    ])
...
def exchange_amount_kb(direction: str, amounts: list[int]) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=BACK, callback_data="casino:exchange")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def bp_levels_kb(page: int, total_pages: int, claimable_levels: list[int]) -> InlineKeyboardMarkup:
    ...
    if page < total_pages:
        nav.append(InlineKeyboardButton(text="➡️", callback_data=f"bp:levels:{page+1}"))
    rows.append(nav)
    rows.append([InlineKeyboardButton(text=f"{BACK} в пропуск", callback_data="bp:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def inventory_kb(items: list) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} в меню", callback_data="nav:progress")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def inventory_item_kb(item_id: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=BACK, callback_data="inv:back")],
    ])
...
def clan_browse_kb(clans: list, refresh_cb: str) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} в кланы", callback_data="clan:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def clan_donate_kb() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[row, [
        ...
        InlineKeyboardButton(text=f"{BACK} в клан", callback_data="clan:back")
    ]])
...
def duel_squad_kb(cars: list, selected_ids: set, owner_id: int) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text="💾 Сохранить состав", callback_data=f"duel:save:{owner_id}",
                                       style=ButtonStyle.SUCCESS)])
    rows.append([InlineKeyboardButton(text=f"{BACK} в дуэли", callback_data="duel:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def auction_my_lots_kb(lots: list, page: int, total_pages: int) -> InlineKeyboardMarkup:
    ...
    if nav:
        rows.append(nav)
    rows.append([InlineKeyboardButton(text=BACK, callback_data="auc:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def premium_container_qty_kb(is_premium: bool = False) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} к контейнерам", callback_data="cont:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def admin_menu_kb(is_head: bool = False, admins_hidden: bool = False) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text=f"{BACK} в игровое меню", callback_data="nav:main")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def admin_catalog_nav_kb(page: int, total_pages: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        nav,
        [InlineKeyboardButton(text=f"{BACK} в админку", callback_data="admin:back")],
    ])
...
def fsub_menu_kb(channels: list) -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text="➕ Добавить канал/группу", callback_data="admin:fsub:add",
                                       style=ButtonStyle.SUCCESS)])
    rows.append([InlineKeyboardButton(text=f"{BACK} в админку", callback_data="admin:back")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
